...
user_movie_count = movies_watched_df.T.notnull().sum()#her bir kullanicin kac tane film izledigi

user_movie_count.columns = ['userId', 'movie_count']

#en az 20 tane ortak izledigi film olan kullanicilar
user_movie_count[user_movie_count["movie_count"] >= 20].sort_values("movie_count", ascending=False)

#hedef kullanicin izledigi filmeleri izleyen kac kullanici vardir?
user_movie_count[user_movie_count["movie_count"] == 33].count() #17'didir

#bunlar hedef kullanici ile ayni filmi izleyen (en az 20 tane film izleyen kullanicilar) kullanicilarin id'leri
#burasi gelistiricinin kendi insiyativine kalmis daha programativ yazilim sekili ise asagida
users_same_movies = user_movie_count[user_movie_count["movie_count"] >= 20]['userId']

# perc = len(movies_watched) * 60/100
#users_same_movies = user_movie_count[user_movie_count['movie_count'] > perc]
...
top_users.rename(columns={'user_is_2': 'userId'}, inplace=True)

#bu kullanicilarin hangi filme kac puan verdigini gormek icin 
rating = pd.read_csv('/home/firengiz/Belgeler/recommedation/rating.csv')
...
#hedef kullanicin begene bilecegi filmler ve bu filmerin isimleri
# weighted_rating'ler hedef kullanicinin vermesini bekledigimiz puanlar degil ama o puanlar etrafinda olmasini bekliyorum 
